...
SECRET_KEY = 'django-insecure-lf=$t(a#$uy#2op5xj105j@kjq1iu&r%mhpt0rbf4vui!oj-gw'
...
INSTALLED_APPS = [
    'booking_meeting_room.apps.BookingMeetingRoomConfig',
...
print("IICCIIIIIIIIIIIIIIIII", TIME_ZONE)
USE_I18N = True
